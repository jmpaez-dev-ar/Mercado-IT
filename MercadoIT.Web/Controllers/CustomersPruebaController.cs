...
{
    public class CustomersPruebaController : Controller
    {
        private readonly NorthwindContext _context;

        public CustomersPruebaController(NorthwindContext context)
        {
            _context = context;
        }
        ...
        // GET: CustomersPrueba/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CustomersPrueba/Create
